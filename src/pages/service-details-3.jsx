  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Transform your business with innovative mobile app development services, delivering high-performance, user-friendly, and custom mobile solutions for Android and iOS platforms."
        />
        <meta
          name="keywords"
          content="mobile app development, custom mobile apps, Android apps, iOS apps, cross-platform apps, Flutter, React Native, mobile solutions, app development services, mobile UI/UX design"
        />
        <meta
          name="viewport"
